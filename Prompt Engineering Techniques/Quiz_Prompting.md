...
- [x] "Create a 30-minute workout plan for beginners"
...
- [x] Provide examples showing sarcastic posts labeled as negative
...
- [x] Improving a prompt to get more reliable, higher-quality outputs
...
- [ ] XML structuring
- [x] One-shot or multi-shot prompting
...
- [x] To add structure and clarity, especially when including large amounts of content
